...
1. How to run the project
   This is a simple python project including 3 parts of machine learning algorithm –tree, parser and main. In the zip file, there will be an extra data directory containing the dataset for learning and testing. In the main python file, it has some validation functions and it is also the entrance for the whole project. The tree file provides two basic classes of the tree and node. The Parser file is designed to parser the data file into other form.
