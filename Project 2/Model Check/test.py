...
b62 = ["a","c","g","h","x","y","z"]# problem 6(2)
a = {1:[a11],2:[a21],3:[a31],4:[a41,a42],5:[a51],6:[a61,a62]}
b = {1:[b11],2:[b21],3:[b31],4:[b41,b41],5:[b51],6:[b61,b62]}
# a represent the CNF which will input into kb, b represent the variable needed to prove
    ...
    while(True):
        ...
        if not number1 <7 or not number1 >0:
            ...
            if not number2 <len(a[number1]) or not number2 >=0:
                ...
                break
    for i in a[number1][number2]:
        knowledge.tell(i)   # input data into kb
    # print(knowledge.kb)
    for i in b[number1][number2]:
        knowledge.ask(i)    # prove the variable
    print("it is done!!!")
